...
/**
 * Clase que representa la interfaz gráfica para modificar datos de automóviles existentes.
 * Permite editar información como modelo, marca, motor, color, patente y cantidad de puertas.
 */
public class ModificarAuto extends javax.swing.JFrame {
    ...
    /**
     * Constructor que inicializa la interfaz y carga los datos del automóvil a modificar.
     * @param idAuto El ID del automóvil que se desea modificar.
     */
     ...
     * Recoge los datos modificados y los envía a la controladora para su actualización.
    ...
    /**
     * Carga los datos del automóvil en los campos del formulario.
     * @param idAuto El ID del automóvil cuyos datos se van a cargar.
     */
    private void cargarDatos(int idAuto) {
     this.auto = control.traerAuto(idAuto);
        ...
        if(auto.getMotor().equalsIgnoreCase("1.0L - 1.6L")){ 
           comboMotor.setSelectedIndex(1); 
        }
        else if(auto.getMotor().equalsIgnoreCase("1.8L - 2.5L")){ 
           comboMotor.setSelectedIndex(2); 
        }
        else{
            comboMotor.setSelectedIndex(3); 
        }
        txtColor.setText(auto.getColor());
        txtPatente.setText(auto.getPatente());
        if(auto.getCantidadPuertas().equalsIgnoreCase("2")){ 
           comboPuertas.setSelectedIndex(1); 
        }
        else if(auto.getMotor().equalsIgnoreCase("3")){ 
           comboPuertas.setSelectedIndex(2); 
        }
        else if(auto.getMotor().equalsIgnoreCase("4")){ 
           comboPuertas.setSelectedIndex(3); 
        }
        else{
            comboPuertas.setSelectedIndex(4); 
        }   
    }
}
